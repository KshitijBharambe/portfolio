    ...
    <>
      ...
      >
        <div
          ...
          style={{
            background: scrolled ? "var(--nav-scrolled-bg)" : "var(--nav-bg)",
            backdropFilter: scrolled ? "blur(24px) saturate(150%)" : "blur(20px) saturate(130%)",
            WebkitBackdropFilter: scrolled ? "blur(24px) saturate(150%)" : "blur(20px) saturate(130%)",
            border: "1px solid var(--glass-border)",
            boxShadow: scrolled ? "0 4px 30px rgba(0,0,0,0.15)" : "0 4px 20px rgba(0,0,0,0.08)",
          }}
        >
          {/* Logo */}
